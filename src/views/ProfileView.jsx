...
export default function ProfileView({ user, onUpdateUser }) {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-8">
      ...
      <form onSubmit={handleInitiateSave} className="space-y-8">
        {/* Personal Details */}
        <div className="bg-white p-8 rounded-3xl border border-slate-200/80 shadow-sm space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div>
              ...
              <div className="px-4 py-2.5 bg-blue-50 border border-blue-200 rounded-xl text-xs font-extrabold text-slate-900 flex items-center justify-between">
                <span>{user?.role === 'Supplier' ? 'Supplier / Merchant' : 'Buyer / Customer'}</span>
